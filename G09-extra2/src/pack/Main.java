...
public class Main {
    ...
    public static void main(String[] args) {
        ArrayList<Edificio> obras = new ArrayList();
        Polideportivo poli1 = new Polideportivo();
        Polideportivo poli2 = new Polideportivo();
        EdificioConOficinas ed1 = new EdificioConOficinas();
        EdificioConOficinas ed2 = new EdificioConOficinas();
        poli1.crearEdificio();
        poli2.crearEdificio();
        ed1.crearEdificio();
        ed2.crearEdificio();
